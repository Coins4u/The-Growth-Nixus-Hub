...
const SERVICE_NAME = "Growth Hub Membership";
...
function getRequiredEnv() {
  ...
  return {
    ...
    smtpPass: values.smtpPass as string,
    smtpFrom: values.smtpFrom as string,
  };
}
...
export async function POST(request: Request) {
  try {
    ...
    const { adminEmail, smtpHost, smtpPort, smtpSecure, smtpUser, smtpPass, smtpFrom } = getRequiredEnv();
    ...
    console.error("Order API email send failure", error);
